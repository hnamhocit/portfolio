...
export function Contact() {
  ...
  return (
    <section id="contact" ref={containerRef} className="py-32 bg-[#02000a] relative border-t border-neutral-900 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        <h2 className="contact-title text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-white font-heading tracking-tight leading-tight">
          Cùng Nhau Tạo Nên <br className="hidden md:block" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-500 to-indigo-400 inline-block mt-2 md:mt-0">Điều Kỳ Diệu</span>
        </h2>
        
        <p className="contact-desc text-neutral-400 text-lg md:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Button size="lg" className="contact-btn relative group bg-white text-black hover:bg-neutral-200 rounded-full px-10 h-14 text-lg font-medium transition-all w-full sm:w-auto overflow-hidden shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(255,255,255,0.2)]">
          ...
          <Button size="lg" variant="outline" className="contact-btn relative group rounded-full px-10 h-14 border-neutral-700 bg-[#0a0a0a] text-white hover:border-fuchsia-500 hover:bg-neutral-900 text-lg font-medium transition-all w-full sm:w-auto overflow-hidden shadow-[0_0_0_rgba(217,70,239,0)] hover:shadow-[0_0_20px_rgba(217,70,239,0.3)]">
