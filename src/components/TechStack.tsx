      ...
      <div className={`w-full h-full border border-purple-500/20 rounded-full ${ringClass}`}>
        {items.map((item: any, index: number) => {
          ...
          return (
            ...
            >
              <div 
                className={`w-12 h-12 md:w-16 md:h-16 bg-[#0a0a0a] rounded-full p-2.5 md:p-3 border border-neutral-700 hover:border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.15)] flex items-center justify-center transition-colors cursor-pointer group ${iconClass}`} 
              >
...
export function TechStack() {
  return (
    <section id="tech" className="py-32 bg-[#030014] relative border-t border-neutral-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative w-full aspect-square max-w-[800px] mx-auto flex items-center justify-center min-h-[400px] md:min-h-[800px]">
          
          {/* Center Hub */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 md:w-28 md:h-28 bg-gradient-to-tr from-purple-600 to-indigo-600 rounded-full z-20 flex items-center justify-center shadow-[0_0_60px_rgba(147,51,234,0.6)] border-4 border-[#030014]">
            <span className="font-bold text-white text-lg md:text-xl font-heading tracking-wider">CORE</span>
          </div>

          {/* Glowing background behind hub */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 md:w-48 md:h-48 bg-purple-500/20 rounded-full blur-3xl z-0 pointer-events-none"></div>
